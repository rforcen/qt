...
******************************************************************************/
ColorReff ColorScaleRGB(	const ColorReff Col1,
                        const ColorReff Col2,
                        const float Ratio) {
...
******************************************************************************/
ColorReff ColorScaleHSL(	const ColorReff Col1,
                        const ColorReff Col2,
                        const float Ratio) {
...
******************************************************************************/
extern ColorReff ColorScaleRGB3(const ColorReff Col1, const ColorReff Col2, const ColorReff Col3,
...
/******************************************************************************
  ...
  NOTE:		In general you want to pass Ratio1=1-Ratio2-Ratio3
            making sure that it stays between 0 and 1
******************************************************************************/
extern ColorReff ColorScaleHSL3(const ColorReff Col1, const ColorReff Col2, const ColorReff Col3,
                               float Ratio1, float Ratio2, float Ratio3) {
...
void RGBtoHLS(	const ColorReff rgb,
...
ColorReff HLStoRGB(const double H, const double L, const double S ) {
    double r,g,b;
    double m1, m2;
